...
This plot is intended to quikly explore possible trends and patterns. To that end it combines the strenghs of human perception with the percs of automatic data preprocessing. While the human is good at finding large general patterns and jude similiarity by it, the computer excells at averaging datapoints that are either many (weekly trends) or far from each other (yearly trends) or cluster data based on small highly frequent patterns.
