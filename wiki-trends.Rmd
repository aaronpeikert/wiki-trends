...
output$final <- renderPlot({
  plot_final(views())
}, execOnResize = TRUE, width = 1800, height = 600)
```

```{r input, echo=FALSE}
sliderInput("nclust", "Number of clusters:", 3, min = 1, max = 6)
textAreaInput("articles", "Articles:", "Alcohol, Nicotine, Caffeine, Cannabis, Methamphetamine, Cocaine, Heroin, Ecstasy, Fentanyl", "400px", "100px")
